...
class Connect(Connector):
    ...
    def __create_tables(self):
        ...
        self.execute(self.tables.station_address_params.create, method="commit")
        self.execute(self.tables.scoreboard_address.create, method="commit")
        self.execute(self.tables.scoreboard_address_params.create, method="commit")
        self.execute(self.tables.last_radio_scoreboard_data.create, method="commit")
        self.execute(self.tables.current_radio_scoreboard_data.create, method="commit")
    ...
    def get_radio_station_address(self, radio_name: str) -> None | StationAddress:
        raw = self.execute(self.tables.station_address.get, (radio_name,), "fetchone")
    ...
    def get_radio_scoreboard_address(self, radio_name: str) -> None | StationScoreboardAddress:
        raw = self.execute(self.tables.scoreboard_address.get, (radio_name,), "fetchone")
    ...
    def set_radio(self, name: str, url: str, params: dict, scoreboard_url: str = None, scoreboard_params: dict = None) -> None:
        ...
        if scoreboard_url is not None:
            scoreboard_id: int = self.execute(self.tables.scoreboard_address.set, (radio_id, scoreboard_url), "lastrowid")
            if scoreboard_params:
                self.execute(self.tables.scoreboard_address_params.set, (scoreboard_id, str(scoreboard_params)))
    ...
    def set_radio_activity(self, guild_id: int, channel_id: int, radio_name: str) -> None:
        self.execute(self.tables.radio_activity.set, (radio_name, guild_id, channel_id))
    ...
    def get_last_scoreboard(self, radio_name: str) -> str | None:
        raw = self.execute(self.tables.last_radio_scoreboard_data.get, (radio_name,), "fetchone")
        if raw is None:
            return None
        return raw[0]
    
    def set_last_scoreboard(self, radio_name: str, data: str) -> None:
        self.execute(self.tables.last_radio_scoreboard_data.set, (radio_name, data))

    def update_last_scoreboard(self, radio_name: str, data: str) -> None:
        self.execute(self.tables.last_radio_scoreboard_data.update, (data, radio_name))
    
    def delete_last_scoreboard(self, radio_name: str) -> None:
        self.execute(self.tables.last_radio_scoreboard_data.delete, (radio_name,))
    
    def get_current_scoreboard(self, radio_name: str) -> str | None:
        raw = self.execute(self.tables.current_radio_scoreboard_data.get, (radio_name,), "fetchone")
        if raw is None:
            return None
        return raw[0]
    
    def set_current_scoreboard(self, radio_name: str, data: str) -> None:
        self.execute(self.tables.current_radio_scoreboard_data.set, (radio_name, data))
    
    def update_current_scoreboard(self, radio_name: str, data: str) -> None:
        self.execute(self.tables.current_radio_scoreboard_data.update, (data, radio_name))
    
    def delete_current_scoreboard(self, radio_name: str) -> None:
        self.execute(self.tables.current_radio_scoreboard_data.delete, (radio_name,))
